	...
	definitions: [
		{
			...
			variableDefinitions: [
				...
				},
				{
					...
					variable: {
						kind: "Variable",
						name: { kind: "Name", value: "minRating" },
					},
				...
				},
				{
					...
					variable: {
						kind: "Variable",
						name: { kind: "Name", value: "maxRating" },
					},
					type: { kind: "NamedType", name: { kind: "Name", value: "Int" } },
				},
				{
				...
				selections: [
					{
						...
						selectionSet: {
							...
							selections: [
								...
								{
									kind: "Field",
									name: { kind: "Name", value: "feedbackCount" },
									arguments: [
										{
											kind: "Argument",
											name: { kind: "Name", value: "minRating" },
	...
	definitions: [
		{
			kind: "OperationDefinition",
			operation: "mutation",
			name: { kind: "Name", value: "AddFeedback" },
			variableDefinitions: [
				{
					kind: "VariableDefinition",
					variable: {
...
} as unknown as DocumentNode<AddFeedbackMutation, AddFeedbackMutationVariables>;
